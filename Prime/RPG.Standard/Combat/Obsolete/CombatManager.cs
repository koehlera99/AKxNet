...
namespace RPG.Standard.Combat
{
    ...
    //        Armor a = new Armor(1, 5, HardnessScale.Platinum, ArmorTypeFlag.Plate, 5);

    //        int r;

    //        r = a.GetResistAmount(WeaponDamageType.Slashing);
    //        r = a.GetResistAmount(WeaponDamageType.Blunt);
    //        r = a.GetResistAmount(WeaponDamageType.Piercing);

    //        a.ArmorTypes = ArmorTypeFlag.Chain;
    ...
    //    /// </summary>
    //    public WeaponDamageType DamageType { get; set; } = WeaponDamageType.None;
    ...
    //    /// <param name="damageValue"></param>
    //    /// <param name="damageType"></param>
    //    public Damage(int damageValue, WeaponDamageType damageType)
    //    {
    //        DamageValue = damageValue;
