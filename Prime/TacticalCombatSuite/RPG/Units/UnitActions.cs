...
namespace TCS.RPG.Units
{
    public partial class Unit
    {
        ...
        //[Obsolete]
        //public void EquipItem(Item i, EquipmentSlots equipmentType)
        //{
        //    if (EquipedItems.ContainsKey(equipmentType))
        //        UnEquipItem(equipmentType);
        //    else if (equipmentType == EquipmentSlots.BothHands)
        //    {
        //        if (EquipedItems.ContainsKey(EquipmentSlots.PrimaryHand))
        //            UnEquipItem(EquipmentSlots.PrimaryHand);
        //        if (EquipedItems.ContainsKey(EquipmentSlots.OffHand))
        //            UnEquipItem(EquipmentSlots.OffHand);
        //    }
        //    else if (equipmentType == EquipmentSlots.PrimaryHand || equipmentType == EquipmentSlots.OffHand)
        //    {
        //        if (EquipedItems.ContainsKey(EquipmentSlots.BothHands))
        //            UnEquipItem(EquipmentSlots.BothHands);
        //    }
        ...
        //[Obsolete]
        //public void UnEquipItem(EquipmentSlots equipmentType)
        //{
        //    if (EquipedItems.ContainsKey(equipmentType))
        //    {
